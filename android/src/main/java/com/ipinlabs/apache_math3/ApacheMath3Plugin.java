...
public class ApacheMath3Plugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), apacheMath3Channel, StandardMethodCodec.INSTANCE);
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("getPlatformVersion")) {
      ...
      try {
        List<Integer> t_in = call.argument("input"); // 다트의 시간은 안먹어
